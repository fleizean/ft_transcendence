# Generated by Django 5.0.1 on 2024-03-02 18:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intra42', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pong.social')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('max_score', models.IntegerField(default=10, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)])),
                ('game_mode', models.CharField(choices=[('vanilla', 'Vanilla'), ('abilities', 'Abilities')], default='vanilla', max_length=10)),
                ('status', models.CharField(choices=[('open', 'Opened'), ('started', 'Started'), ('ended', 'Ended')], default='open', max_length=10)),
                ('start_date', models.DateTimeField(auto_now_add=True)),
                ('played_games_count', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(3)])),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='creator_tournament', to=settings.AUTH_USER_MODEL)),
                ('final_round_matches', models.ManyToManyField(blank=True, related_name='final_round_matches', to='pong.game')),
                ('first_round_matches', models.ManyToManyField(blank=True, related_name='first_round_matches', to='pong.game')),
