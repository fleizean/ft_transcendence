...
else
{
    ...
    var chatUser = '';
    var username = otherUser.getAttribute("data-username");
    var secondUser = otherUser.getAttribute("data-seconduser");
    if( user !== username)
        chatUser = username;
    else 
        chatUser = secondUser;
    ...
    chatInviteButton.onclick = function (e) {
        const message = 
        `<li class="conversation-item">
            <div class="conversation-item-content">
                <div class="conversation-item-wrapper">
